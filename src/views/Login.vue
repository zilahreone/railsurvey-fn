<script setup></script>
<template>
  <div id="app2" class="bg-yellow-400 h-screen overflow-hidden flex items-center justify-center">
    <div class="bg-white lg:w-5/12 md:6/12 w-10/12 shadow-3xl">
      ...
      <form class="p-12 md:p-24">
        <div class="flex items-center text-lg mb-6 md:mb-8">
          ...
          <input type="text" id="username" class="bg-gray-200 pl-12 py-2 md:py-4 focus:outline-none w-full"
        ...
        <div class="flex items-center text-lg mb-6 md:mb-8">
          ...
          <input type="password" id="password" class="bg-gray-200 pl-12 py-2 md:py-4 focus:outline-none w-full"

  ...
  <Transition>
    <div v-if="isLoad" class="flex flex-grow">
      <div class="flex items-center text-center lg:text-left px-8 md:px-12 lg:w-1/2">
        <div>
          <h2 class="text-3xl font-semibold text-gray-800 md:text-4xl">บันทึกความเสียหายของ <span class="text-indigo-600">รางรถไฟ</span></h2>
          ...
          <div class="flex justify-center lg:justify-start mt-6">
              ...
              <router-link to="/survey-list" class="ml-4 px-4 py-3 bg-gray-500 text-gray-200 text-xs font-semibold rounded hover:bg-gray-800">Survey List</router-link>
